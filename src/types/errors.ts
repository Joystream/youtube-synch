export namespace ExitCodes {
  export enum YoutubeApi {
    ...
    VIDEO_PRIVACY_STATUS_NOT_UNLISTED = 'VIDEO_PRIVACY_STATUS_NOT_UNLISTED', // TODO: Add this to the error message
    VIDEO_TITLE_NOT_MATCHING = 'VIDEO_TITLE_NOT_MATCHING', // TODO: Add this to the error message
