...
let conf: {
  ...
  VIDEO_PROCESSING_SERVER_PORT: string
  VIDEO_PROCESSING_SERVER_URL: string
  YOUTUBE_CLIENT_SECRET: string
  JOYSTREAM_CHANNEL_COLLABORATOR_ACCOUNT_MNEMONIC: string
...
function configure(): void {
  const envConf: Readonly<typeof conf> = {
    ...
    VIDEO_PROCESSING_SERVER_PORT: readEnv('VIDEO_PROCESSING_SERVER_PORT'),
    VIDEO_PROCESSING_SERVER_URL: readEnv('VIDEO_PROCESSING_SERVER_URL'),
    YPP_OWNER_KEY: readEnv('YPP_OWNER_KEY'),
    JOYSTREAM_CHANNEL_COLLABORATOR_ACCOUNT_MNEMONIC: readEnv('JOYSTREAM_CHANNEL_COLLABORATOR_ACCOUNT_MNEMONIC', false),
